...
print("The result differs in type because of the type of the numbers being divided")
...
print(even%2)
print(odd%2)
print("By using modulus operator and dividing by 2, we can tell whether or not we divided an even or odd number depending on if there is a remainder")
