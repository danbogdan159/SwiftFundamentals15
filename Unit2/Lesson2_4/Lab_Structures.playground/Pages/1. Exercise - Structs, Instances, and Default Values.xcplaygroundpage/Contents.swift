...
favoriteBook.title = "The Hobbit"
favoriteBook.author = "Tolkien"
favoriteBook.pages = 200
favoriteBook.price = 30
print("My favorite book is \(favoriteBook.title) by \(favoriteBook.author), \(favoriteBook.pages) pages, \(favoriteBook.price) dollars")
