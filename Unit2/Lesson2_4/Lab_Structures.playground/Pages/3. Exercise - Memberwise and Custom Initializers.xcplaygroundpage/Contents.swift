...
let favoriteBook = Book(title: "The Hobbit", author: "Tolkien", pages: 200, price: 30.0)
...
let laptop1 = Laptop(yearPurchased: 2009)
let laptop2 = Laptop(yearPurchased: 2010)
...
var myHeight = Height(inches: 68)
print("Height in cm: \(myHeight.heightInCentimeters)")
/*:
