...
//This does not work because falcon inherited directly from Spaceship, which did not have a weapon property defined. If falcon was an instance of the fighter subclass however, it would have had the weapon property initialized.
